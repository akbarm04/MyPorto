...
export default function Loading() {
  ...
  return (
    <div className={`fixed inset-0 ${isDark ? "bg-black" : "bg-white"} z-50 flex flex-col items-center justify-center`}>
      <div className="w-64 relative">
        {/* Main loading bar container */}
        <div className={`h-2 w-full ${isDark ? "bg-gray-800" : "bg-gray-200"} rounded-full overflow-hidden relative`}>
          {/* Gradient background */}
          <motion.div
        ...
        <motion.div
          className={`mt-2 text-center ${isDark ? "text-gray-400" : "text-gray-600"} text-sm relative`}
          animate={{
            textShadow: [
